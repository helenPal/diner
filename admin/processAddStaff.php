...
//N.B this is where there shoud be detailed serveside validation

	//set up query
	$query = "insert into tblEmployee(employeeFirstName, employeeLastName, employeeDOB, 
			employeePayrate, employeeAddress, employeePhone,employeePhoto) 
			values('$empFirstName', '$empLastName','$empDOB', '$empPayRate', '$empAddress', '$empPhone','$empPhoto')";
	...
	if ( !$result ) {
		...
		?>
			...
			<?php
				echo( "Employee $empFirstName $empLastName added successfully" );
			?>
			</div>
	<?php
