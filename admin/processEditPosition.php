	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				$posCodeOrig = $_POST[ 'txtPosCodeO' ];
				$posCode = mysqli_real_escape_string( $link, $_POST[ 'txtPosCode' ] );
				$posDesc = mysqli_real_escape_string( $link, $_POST[ 'txtPosDesc' ] );

				//set up query
				$query = "update tblposition set
						positionCode='$posCode' ,
						positionDescription ='$posDesc'
						WHERE positionCode='$posCodeOrig'";
				...
				<div class="alert alert-success" role="alert">
					<?php
					echo( "Position $posDesc edited successfully" );
					?>
				</div>
			</div>
		</div>
